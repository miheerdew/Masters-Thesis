...
\end{align*}
In other words, among the vertices visited infinitely often, consider the largest priority. If this is odd then \Player{1} wins the play, when it is even \Player{0} wins.
