...
\begin{document}
    ...
    \begin{standaloneframe}{Simple Stochastic Game}
        ...
        \onslide<+->{Circle can win from \tikz \node[inner sep=0, minimum size=1ex,circle,draw=black] {}; with probability 1 }
    ...
    \end{standaloneframe}
    \begin{standaloneframe}{Simple Stochastic Games}
    ...
    \begin{standaloneframe}[label=current]{Timeline}
        \begin{itemize}
